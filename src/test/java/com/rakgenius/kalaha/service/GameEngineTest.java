...
public class GameEngineTest {
    ...
    public void shouldStartWithOwnPit(){
        ...
        Assert.assertEquals(Integer.valueOf(1), game.getBoard().getPitMap().get(Board.PLAYER1_HOUSE).getStoneCount());
        Assert.assertEquals(Integer.valueOf(0), game.getBoard().getPitMap().get(Board.PLAYER2_HOUSE).getStoneCount());

    }

    @Test(expected = KalahaGameIllegalMoveException.class)
    public void shouldNotStartWithEmptyPit(){
        //given
        Game game = new Game(6);
        Pit pit = game.getBoard().getPitMap().get(2);
        pit.setStoneCount(0);
    ...
    public void shouldDistributeStoneFromPlayer2PitToPlayer1Pit() {
        ...
        Assert.assertEquals(Integer.valueOf(7), game.getBoard().getStoneCountByPitIndex(4));
        Assert.assertEquals(GameStatus.PLAYER1_TURN, game.getGameStatus());
        Assert.assertEquals(Integer.valueOf(0), game.getBoard().getPitMap().get(Board.PLAYER1_HOUSE).getStoneCount());
        Assert.assertEquals(Integer.valueOf(1), game.getBoard().getPitMap().get(Board.PLAYER2_HOUSE).getStoneCount());
    }
    ...
    public void shouldDistribute13Stone(){
        //given
        Game game = new Game(6);
        game.getBoard().getPitMap().get(4).setStoneCount(13);
        game.getBoard().getPitMap().get(10).setStoneCount(10);
        ...
        Assert.assertEquals(GameStatus.PLAYER2_TURN, game.getGameStatus());
        Assert.assertEquals(Integer.valueOf(13), game.getBoard().getPitMap().get(Board.PLAYER1_HOUSE).getStoneCount());
        Assert.assertEquals(Integer.valueOf(0), game.getBoard().getPitMap().get(Board.PLAYER2_HOUSE).getStoneCount());
    }
    ...
    public void shouldIncreaseHouseStoneOnOwnEmptyPit() {
        ...
        Assert.assertEquals(GameStatus.PLAYER2_TURN, game.getGameStatus());
        Assert.assertEquals(Integer.valueOf(7), game.getBoard().getPitMap().get(Board.PLAYER1_HOUSE).getStoneCount());
        Assert.assertEquals(Integer.valueOf(0), game.getBoard().getPitMap().get(Board.PLAYER2_HOUSE).getStoneCount());
    }
    ...
    public void shouldChangeGameToPlayerTurn2Again() {
        ...
        //when
        Pit pit = game.getBoard().getPitMap().get(8);
        pit.setStoneCount(6);
    ...
    public void shouldGameOver() {
        ...
        game.getBoard().getPitMap().get(6).setStoneCount(1);
    ...
    public void shouldPlayer1Win() {
        ...
        Pit lastPit = game.getBoard().getPitMap().get(6);
    ...
    public void shouldPlayer2Win(){
        ...
        game.getBoard().getPitMap().get(13).setStoneCount(1);
    ...
    public void shouldDraw(){
        ...
        game.getBoard().getPitMap().get(6).setStoneCount(1);
        game.getBoard().getPitMap().get(14).setStoneCount(1);
